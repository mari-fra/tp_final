...
Los factores que determinan qué tan bien funcionará un algoritmo de Machine Learning pueden dividirse en dos categorías principales\footnote{Goodfellow, I., Bengio, Y., \& Courville, A. (2016). \textit{Deep Learning}. MIT Press.}: 1) hacer que el training error sea pequeño, y 2) hacer que la brecha entre training error y test error sea pequeña. Estos dos factores corresponden a los dos desafíos centrales en Machine Learning: \emph{underfitting} y \emph{overfitting}.
...
El descenso de gradiente (GD) es un algoritmo de optimización que minimiza iterativamente una función objetivo. En el contexto del Machine Learning, esta técnica se utiliza durante la fase de entrenamiento de un modelo supervisado para minimizar la función de pérdida o costo, que mide qué tan lejos están las predicciones del modelo de los valores reales de los datos\footnote{IBM. \textit{Stochastic Gradient Descent}. \url{https://www.ibm.com/mx-es/think/topics/stochastic-gradient-descent}}. Un ejemplo común de función de costo es el error cuadrático medio.
...
\subsection{Modelos de Machine Learning para Clasificación de Texto}
...
\bibitem{ibm-sgd}
IBM. \textit{Stochastic Gradient Descent}. IBM Think Topics.
\url{https://www.ibm.com/mx-es/think/topics/stochastic-gradient-descent}

\bibitem{stanford-sgd}
Stanford University. \textit{Optimization: Stochastic Gradient Descent}. UFLDL Tutorial.
